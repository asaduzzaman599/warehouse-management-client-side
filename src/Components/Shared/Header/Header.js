...
const Header = () => {
    ...
    return (
        <header className='bg-slate-800'>
            <nav className=' mx-auto md:flex justify-between items-center py-6  container text-white gap-10 relative'>
                ...
                <div className={`flex flex-col md:flex-row py-4  items-center justify-between  md:grow absolute md:static w-full md:w-auto bg-slate-800 ${isOpen ? "top-16" : "top-[-200px]"}`}>
